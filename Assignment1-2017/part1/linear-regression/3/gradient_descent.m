function theta = gradient_descent(X, y, theta, alpha, iterations, I, do_plot)
...
%         update theta(2) and store in temporary variable theta_1
       ...
       theta_1 = theta_1 * (1 - alpha * (I/m)) - ((alpha * 1.0) / m) * sigma;
...
%         update theta(3) and store in temporary variable theta_1
       ...
       theta_2 = theta_2 * (1 - alpha * (I/m)) - ((alpha * 1.0) / m) * sigma; 
       
%         update theta(4) and store in temporary variable theta_1
        sigma = 0.0;
       ...
       theta_3 = theta_3 * (1 - alpha * (I/m)) - ((alpha * 1.0) / m) * sigma;
       
%         update theta(5) and store in temporary variable theta_1
        sigma = 0.0;
       ...
       theta_4 = theta_4 * (1 - alpha * (I/m)) - ((alpha * 1.0) / m) * sigma;
       
%         update theta(6) and store in temporary variable theta_1
        sigma = 0.0;
       ...
       theta_5 = theta_5 * (1 - alpha * (I/m)) - ((alpha * 1.0) / m) * sigma;
       ...
       theta(6) = theta_5;
        ...
        cost_vector = [cost_vector; compute_cost_regularised(X, y, theta,I)];
